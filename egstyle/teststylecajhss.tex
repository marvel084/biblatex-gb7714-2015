...
\footfullcite{吴虞1917} \qd{注意：特殊的期刊卷期在年份前且与年份之间存在逗号的，要将这些信息放到issue中，比如issue=\{第2卷第6号\}。而后面的填入series域的信息和年份之间是没有逗号的。这是这个样式期刊论文中issue和series的主要差别。}
